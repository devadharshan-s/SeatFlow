...
public class ReddisonConfig {
    ...
    public RedissonClient redissonClient() {
        ...
        try {
            ...
            log.warn("Could not connect to Redis at {} during startup: {}. Initializing fallback proxy.", address, ex.getMessage());
        ...
        return (RedissonClient) Proxy.newProxyInstance(
                ...
                (proxy, method, args) -> {
                    ...
                    throw new RedisConnectionException(
                            "Redis server is unreachable at " + redisHost + ":" + redisPort
                    );
                }
        );
    }
